$(document).ready(function(){
	...
	hammertime.on('swiperight', function(){okNext();});
	hammertime.on('swipeleft', function(){okPrev();});
	...
	function rectangle(element){
		...
		console.log('height calculated: ' + Math.floor($(element).height() * 0.7));
		console.log('width calculated: ' + Math.floor($(element).width() * 0.7));
